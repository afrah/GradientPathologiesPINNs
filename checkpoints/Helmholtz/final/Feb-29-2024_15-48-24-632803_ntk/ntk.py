...
class Helmholtz2D:
 ...
 ############################################################
    ...
    def plot_lambda(self ):
        ...
        # fig, ax = plt.subplots()
        # fig.set_size_inches([15,8])
        ax2.semilogy(self.adpative_constant_bc_log, label=r'$\bar{\lambda_{bc}}$'  ,  linestyle='dashed' , color = 'tab:green') 
        ax2.semilogy(self.adpative_constant_res_log, label=r'$\bar{\lambda_{phy}}$'  ,  linestyle='dashed' , color = 'tab:red') 
