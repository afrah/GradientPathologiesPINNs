...
class Helmholtz2D:
    def __init__(self, layers, operator, ics_sampler, bcs_sampler, res_sampler, lam, mode ,  starter_learning_rate , PATH , sess ):
        ...
        # Adaptive constant
        self.beta = 0.9
        self.adaptive_constant_bc_val = np.array(100.0)
        self.adaptive_constant_res_val = np.array(10.0)
 ...
 ############################################################
    ...
    def train(self, nIter=10000, batch_size=128):
        ...
        for it in range(nIter):
            ...
            if it % 1000 == 0:
                ...
                summation = mean_grad_res +  mean_grad_bcs
                self.adaptive_constant_bc_val = summation / mean_grad_bcs
                self.adaptive_constant_res_val =summation / mean_grad_res
    ...
    def make_output_dir(self , PATH):
        ...
        shutil.copyfile('/home/vlq26735/code/PhD/GradientPathologiesPINNs/src/cases/Helmholtz/M3.py', os.path.join(dirname, 'M3.py'))
