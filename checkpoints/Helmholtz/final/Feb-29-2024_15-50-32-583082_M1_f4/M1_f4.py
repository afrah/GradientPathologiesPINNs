...
class Helmholtz2D:
    def __init__(self, layers, operator, ics_sampler, bcs_sampler, res_sampler, lam, mode ,  starter_learning_rate , PATH , sess ):
        ...
        # Boundary loss
        self.loss_bc1 = self.loss_function4((self.u_bc1_tf - self.u_bc1_pred))
        self.loss_bc2 = self.loss_function4((self.u_bc2_tf - self.u_bc2_pred))
        self.loss_bc3 = self.loss_function4((self.u_bc3_tf - self.u_bc3_pred))
        self.loss_bc4 = self.loss_function4((self.u_bc4_tf - self.u_bc4_pred))
        ...
        # Total loss
        self.loss = self.loss_res + 1000 * self.loss_bcs
 ...
 ############################################################
    ...
    def make_output_dir(self , PATH):
        ...
        shutil.copyfile('/home/vlq26735/code/PhD/GradientPathologiesPINNs/src/cases/Helmholtz/M1_f4.py', os.path.join(dirname, 'M1_f4.py'))
