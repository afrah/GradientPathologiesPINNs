...
class PINN:
    ...
    def trainmb(self, nIter=10000, batch_size=128, log_NTK=False, update_lam=False):
        ...
        for it in range(nIter):
            ...
            if it % 1000 == 0:
                ...
                self.adaptive_constant_ics_val = summation/mean_grad_ics
                self.adaptive_constant_bcs_val = summation /mean_grad_bcs
    ...
    def make_output_dir(self , PATH):
        ...
        shutil.copyfile('/home/vlq26735/code/PhD/GradientPathologiesPINNs/src/cases/Wave/M3.py', os.path.join(dirname, 'M3.py'))
