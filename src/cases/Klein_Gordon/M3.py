...
class Klein_Gordon:
    ...
    def train(self, nIter=10000, batch_size=128):
        ...
        for it in range(nIter):
            ...
            if it % 1000 == 0:
                ...
                if it == 0:
                    summation = mean_grad_res +  mean_grad_bcs  +  mean_grad_ics
                    self.adaptive_constant_ics_val = (summation / mean_grad_ics) if mean_grad_ics != 0.0 else 1.0
                    self.adaptive_constant_bcs_val =  (summation  / mean_grad_bcs) if mean_grad_bcs != 0.0 else 1.0
                    self.adaptive_constant_res_val =  (summation  / mean_grad_res) if mean_grad_res != 0.0 else 1.0
    ...
    def make_output_dir(self , PATH):
        ...
        shutil.copyfile('/home/vlq26735/code/PhD/GradientPathologiesPINNs/src/cases/Klein_Gordon/M3.py', os.path.join(dirname, 'M3.py'))
