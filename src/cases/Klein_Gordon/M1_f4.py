...
class Klein_Gordon:
    ...
    def __init__(self, layers, operator, ics_sampler, bcs_sampler, res_sampler, 
        ...
        self.loss_ic_u =self.loss_function4((self.u_ics_tf - self.u_ics_pred))
        self.loss_ic_u_t =self.loss_function4((self.u_t_ics_pred))
        self.loss_bc1 =self.loss_function4((self.u_bc1_pred - self.u_bc1_tf))
        self.loss_bc2 =self.loss_function4((self.u_bc2_pred - self.u_bc2_tf))

        self.loss_bcs =  (self.loss_ic_u + self.loss_bc1 + self.loss_bc2)

        # Residual loss
        self.loss_res =self.loss_function4((self.r_pred - self.r_tf))
    ...
    def make_output_dir(self , PATH):
        ...
        shutil.copyfile('/home/vlq26735/code/PhD/GradientPathologiesPINNs/src/cases/Klein_Gordon/M1_f4.py', os.path.join(dirname, 'M1_f4.py'))
