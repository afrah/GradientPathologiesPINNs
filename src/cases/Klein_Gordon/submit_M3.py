...
from src.cases.Klein_Gordon import M3
...
# sess.run(init)
model = M3.Klein_Gordon(layers, operator, ics_sampler, bcs_sampler, res_sampler, alpha, beta, gamma, k, MODE,starter_learning_rate, CHECKPOINT_PATH , sess)
