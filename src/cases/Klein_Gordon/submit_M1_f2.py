...
from src.cases.Klein_Gordon import M1_f2
...
# sess.run(init)
model = M1_f2.Klein_Gordon(layers, operator, ics_sampler, bcs_sampler, res_sampler, alpha, beta, gamma, k, MODE,starter_learning_rate, CHECKPOINT_PATH , sess)
