...
from src.cases.Poisson import M2
...
model = M2.Possion_M2(layers, X_u, Y_u, X_r, Y_r , mode ,starter_learning_rate , CHECKPOINT_PATH , sess)    
...
model.print("learning_rates: " , starter_learning_rate)

model.print("Method desciption : gradual learing rate , " ,  model.mode , " weighting with velocity pressure representation. " , method ," batch. ")
