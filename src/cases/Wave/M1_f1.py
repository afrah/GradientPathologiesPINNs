...
class PINN:
    ...
    def __init__(self, layers, ics_sampler, bcs_sampler, res_sampler, c , mode ,  starter_learning_rate , PATH , sess ):
        ...
        self.loss_ics_u =self.loss_function1((self.u_ics_tf - self.u_ics_pred))
        self.loss_ics_u_t =self.loss_function1((self.u_t_ics_pred))
        self.loss_bc1 =self.loss_function1((self.u_bc1_pred))
        self.loss_bc2 =self.loss_function1((self.u_bc2_pred))

        self.loss_bcs = self.loss_ics_u + self.loss_bc1 + self.loss_bc2

        # Residual loss
        self.loss_res =self.loss_function1((self.r_pred))
    ...
    def make_output_dir(self , PATH):
        ...
        shutil.copyfile('/home/vlq26735/code/PhD/GradientPathologiesPINNs/src/cases/Wave/M1_f1.py', os.path.join(dirname, 'M1_f1.py'))
