...
from src.cases.Helmholtz import M1_f4
...
model = M1_f4.Helmholtz2D(layers, operator, ics_sampler, bcs_sampler, res_sampler, lam, MODE,starter_learning_rate , CHECKPOINT_PATH , sess)
